$(document).ready(function () {
  ...
  // 9AM
  var t0 = localStorage.getItem("08:00");
  $("#eight-am").text(t0);

  // 10AM
  var t1 = localStorage.getItem("09:00");
  $("#nine-am").text(t1);

  // 11AM
  var t2 = localStorage.getItem("10:00");
  $("#eleven-am").text(t2);

  // 12PM
  var t3 = localStorage.getItem("11:00");
  $("#twelve-pm").text(t3);

  // 1PM
  var t4 = localStorage.getItem("12:00");
  $("#one-pm").text(t4);

  // 2PM
  var t5 = localStorage.getItem("13:00");
  $("#two-pm").text(t5);

  // 3PM
  var t6 = localStorage.getItem("14:00");
  $("#three-pm").text(t6);

  // 4PM
  var t7 = localStorage.getItem("15:00");
  $("#four-pm").text(t7);

  // 5PM
  var t8 = localStorage.getItem("16:00");
  $("#five-pm").text(t8);
